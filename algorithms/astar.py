...
class AStar:
    ...
    def find_path(game_map, start, goal):
        ...
        g_start = 0
        f_start = g_start + AStar.heuristic(start, goal)
        ...
        while heap:
            ...
            if current in expanded_nodes and expanded_nodes[current] <= g_cost:
                continue
                
            expanded_nodes[current] = g_cost
            ...
            for dx, dy in directions:
                ...
                if result:
                    ...
                    new_f = new_g + AStar.heuristic(next_pos, goal)
